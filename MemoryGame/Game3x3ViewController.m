...
#import "Game3x3ViewController.h"
#import "HighScore.h"
#import "AppDelegate.h"

@interface Game3x3ViewController ()

@end

@implementation Game3x3ViewController {
    
    AppDelegate* appDelegate;
}

@synthesize nameString,nameLabel,scorelabel,countdownLabel,gameTimerLabel,highScoreLabel;
...
- (void)arrayToString:(bool [3][3])array
{
...
- (void)viewDidLoad {
    ...
    buttonNo = 1;
    pressCount = 0;
    img = [UIImage imageNamed:@"apple.png"];
