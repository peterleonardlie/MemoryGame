...
#import "Game5x5ViewController.h"
#import "AppDelegate.h"
#import "HighScore.h"

@interface Game5x5ViewController ()

@end

@implementation Game5x5ViewController {
...
- (void)viewDidLoad {
    ...
    buttonNo = 1;
    pressCount = 0;
    img = [UIImage imageNamed:@"kiwi.png"];
