...
#import "Game6x6ViewController.h"
#import "AppDelegate.h"
#import "HighScore.h"

@interface Game6x6ViewController ()

@end

@implementation Game6x6ViewController {
...
- (void)viewDidLoad {
    ...
    buttonNo = 1;
    pressCount = 0;
    img = [UIImage imageNamed:@"watermelon.png"];
